...
export interface Transaction {
  ...
  created_at: string
  updated_at: string
  // Joined relations (optional, for queries)
...
// Database type map for Supabase generic helpers
export interface Database {
  public: {
    Tables: {
      ...
      transactions: {
        Row: Transaction
        Insert: Omit<Transaction, 'id' | 'created_at' | 'updated_at' | 'category' | 'account'>
        Update: Partial<Omit<Transaction, 'id' | 'created_at' | 'updated_at' | 'category' | 'account'>>
      }
      budgets: {
        Row: Budget
        Insert: Omit<Budget, 'id' | 'created_at' | 'updated_at' | 'category'>
        Update: Partial<Omit<Budget, 'id' | 'created_at' | 'updated_at' | 'category'>>
      }
      recurring_transactions: {
        Row: RecurringTransaction
        Insert: Omit<RecurringTransaction, 'id' | 'created_at' | 'updated_at' | 'category' | 'account'>
        Update: Partial<Omit<RecurringTransaction, 'id' | 'created_at' | 'updated_at' | 'category' | 'account'>>
      }
      savings_goals: {
        Row: SavingsGoal
